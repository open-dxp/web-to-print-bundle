opendxp.registerNS("opendxp.bundle.web2print.startup");

opendxp.bundle.web2print.startup = Class.create({
    ...
    preMenuBuild: function (e) {
        ...
        if (user.isAllowed("web2print_settings") && perspectiveCfg.inToolbar("settings.web2print")) {
            ...
            menu.settings.items.push({
                ...
                iconCls: "opendxp_nav_icon_print_settings",
                priority: 55,
                itemId: 'opendxp_menu_settings_web2print_settings',
    ...
    web2printSettings: function () {
        try {
            opendxp.globalmanager.get("bundle_web2print").activate();
        }
        catch (e) {
            opendxp.globalmanager.add("bundle_web2print", new opendxp.bundle.web2print.settings());
        }
    },
        ...
        if (childSupportedDocument && document.data.permissions.create) {
            ...
            if (addBlankPrintDocuments) {
                ...
                documentMenu.printPage.push({
                    ...
                    iconCls: "opendxp_icon_printpage opendxp_icon_overlay_add",
                    handler: me.addDocument.bind(tree, tree, document, "printpage")
                });
                documentMenu.printPage.push({
                    text: "&gt; " + t("add_printcontainer"),
                    iconCls: "opendxp_icon_printcontainer opendxp_icon_overlay_add",
            ...
            if (button == "ok") {
                if (value) {
                    ...
                    let params = {
                        ...
                        parentId: record.id,
                        url: Routing.generate('opendxp_bundle_web2print_document_' + type + '_add')
                    };
...
const opendxpBundleWeb2print = new opendxp.bundle.web2print.startup();
