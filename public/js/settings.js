...
opendxp.registerNS("opendxp.bundle.web2print.settings");
/**
 * @private
 */
opendxp.bundle.web2print.settings = Class.create({
    ...
    getData: function () {
        Ext.Ajax.request({
            url: Routing.generate('opendxp_bundle_web2print_settings_getweb2print'),
    ...
    getTabPanel: function () {
        ...
        if (!this.panel) {
            this.panel = Ext.create('Ext.panel.Panel', {
                id: "opendxp_settings_web2print",
                title: t("web2print_settings"),
                iconCls: "opendxp_icon_printpage opendxp_icon_overlay_setting",
                border: false,
                layout: "fit",
                closable: true
            });
            ...
            this.panel.on("destroy", function () {
                opendxp.globalmanager.remove("bundle_web2print");
            }.bind(this));
                ...
                buttons: [
                    {
                        ...
                        icon: "/bundles/opendxpadmin/img/flat-color-icons/approval.svg"
                    },
                    {
                        text: t("save"),
                        handler: this.save.bind(this),
                        iconCls: "opendxp_icon_apply",
                        disabled: !opendxp.settings['web2print-writeable']
                    }
                ],
                items: [
                    {
                    ...
                    , this.pdfReactorSettings, this.gotenbergSettings
                ]
            });
    ...
    activate: function () {
        var tabPanel = Ext.getCmp("opendxp_panel_tabs");
        tabPanel.setActiveItem("opendxp_settings_web2print");
    },
    ...
    save: function () {
        ...
        Ext.Ajax.request({
            url: Routing.generate('opendxp_bundle_web2print_settings_setweb2print'),
            method: "PUT",
            params: {
    ...
    test: function () {
        window.open(Routing.generate('opendxp_bundle_web2print_settings_testweb2print'), "_blank");
    }
});
