...
opendxp.registerNS("opendxp.document.printabstract");
/**
 * @private
 */
opendxp.document.printabstract = Class.create(opendxp.document.page_snippet, {
    type: "printabstract",
    ...
    getDataRoute: function() {
        return "opendxp_bundle_web2print_document_" + this.type + '_getdatabyid';
    },

    getSaveRoute: function() {
        return "opendxp_bundle_web2print_document_" + this.type + '_save';
    },

    getAddRoute: function() {
        return "opendxp_bundle_web2print_document_" + this.type + '_add';
    },

    getSaveToSessionRoute: function() {
        return "opendxp_bundle_web2print_document_" + this.type + '_savetosession';
    },

    getRemoveFromSessionRoute: function() {
        return "opendxp_bundle_web2print_document_" + this.type + '_removefromsession';
    },
