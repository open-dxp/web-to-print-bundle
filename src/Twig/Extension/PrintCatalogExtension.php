...
class PrintCatalogExtension extends AbstractExtension
{
    ...
    protected function printImageGallery(\OpenDxp\Model\DataObject\Data\ImageGallery $imageGallery, string $thumbnailName): string
    {
    ...
    protected function printHotspotImage(\OpenDxp\Model\DataObject\Data\Hotspotimage $hotspotimage, string $thumbnailName): string
    {
