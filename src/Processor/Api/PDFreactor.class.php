...
class PDFreactor
{
     ...
     */
    public function getDocumentUrl($documentId, $pageNumber = null)
    {
        if (!is_null($documentId)) {
...
{
    public function __construct($errorId, $clientMessage, $serverMessage, $result)
    {
